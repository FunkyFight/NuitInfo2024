    ...
    return  <>
            <div className="w-full h-96 bg-slate-400 relative overflow-hidden ">
                <span className="w-[50%] h-full absolute bottom-0 left-0">
                    <img src={img1} alt="" className="object-cover w-full h-full bg-red-500 select-none drag-none"/>
                </span>
                ...
                <span className="absolute bottom-0 left-[50%] translate-x-[-50%] origin-center"  style={{
                    ...
                    <img src={img_bodypart} alt="" className="object-cover w-72 h-40 bg-pink-500 select-none drag-none" />
                </span>
            </div>
